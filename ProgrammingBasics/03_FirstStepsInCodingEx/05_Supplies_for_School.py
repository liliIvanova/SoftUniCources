...
# трябва да купи определен брой
# пакетчета с химикали,
# пакетчета с маркери, както и
...
sum = (PENS * pens_cnt + MARKERS * markers_cnt + DETERGENT*detergent_litres)
disc_sum = sum - sum * discount
