...
# Когато се изчислява колко пъти Иван ще се забави, в резултат на съпротивлението на водата, резултатът трябва да се закръгли надолу до най-близкото цяло число.
...
WATER_RESISTANCE = 15
WATER_RESISTS_DELAY = 12.5

world_record = float(input())
distance = float(input())
time_for_1m = float(input())

delay_cnt = distance//WATER_RESISTANCE

delay_time = delay_cnt * WATER_RESISTS_DELAY
time = distance * time_for_1m + delay_time

if time < world_record:
    print(f" Yes, he succeeded! The new world record is {time:.2f} seconds.")
else:
    print(f"No, he failed! He was {abs(world_record - time):.2f} seconds slower.")